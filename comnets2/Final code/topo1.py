...
def run():
    ...
    r7 = net.addHost( 'r7' , ip='192.168.4.3/24', inNamespace=False )
    ...
    net.addLink( h2, r5, intfName2='r5-eth2', params2={'ip' : '192.168.2.2/24' }  )
    net.addLink( h3, r6, intfName2='r6-eth3', params2={'ip' : '192.168.3.2/24' } )
    net.addLink( h4, r7, intfName2='r7-eth2', params2={'ip' : '192.168.4.2/24' } )
#    net.addLink( r1, r2 )
